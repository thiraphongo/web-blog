            ...
            <div className="col">
              ...
              <div className="register-form py-4">
                ...
                <form action="" className="form-register form flex flex-col gap-y-4  py-4">
                  ...
                  <input type="email" name="email" placeholder="Email" id="email" value={UserData.email} onChange={changeInput} autoFocus />
                  <input type="password" name="password" placeholder="Password" id="password" value={UserData.password} onChange={changeInput} autoFocus />
                  <input type="password" name="password2" placeholder="Confirm Password" id="password2" value={UserData.password} onChange={changeInput} autoFocus />
