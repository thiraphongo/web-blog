...
const PostDetail = () => {
  return (
    <section className="post-details py-10 px-20">
      <div className="container mx-auto px-10">
        <div className="content single-post text-center">
         <div className="title-post-detail py-10 px-10">
         <h5>BLOG</h5>
         <h1 className="text-3xl font-bold text-primary">Header Title Blog 01</h1>
         </div>
