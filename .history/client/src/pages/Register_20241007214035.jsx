            ...
            <div className="col">
              ...
              <div className="register-form py-4">
                ...
                <form action="" className="form-register form">
                  ...
                  <input type="email" name="username" placeholder="Email" id="username" value={UserData.email} onChange={changeInput} autoFocus />
                  <input type="password" name="username" placeholder="Password" id="username" value={UserData.username} onChange={changeInput} autoFocus />
                </form>
              </div>
            </div>
          </div>
