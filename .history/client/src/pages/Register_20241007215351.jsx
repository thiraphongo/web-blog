            ...
            <div className="col">
              ...
              <div className="register-form py-4">
                ...
                <form action="" className="form-register form flex flex-col gap-y-4  py-4">
                  ...
                  <input type="text" name="username" placeholder="Username" id="username" className="h-10 px-2 border border-solid border-2 border-slate-400 rounded-sm" value={UserData.username} onChange={changeInput} autoFocus />
